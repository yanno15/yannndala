...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="orb w-[300px] h-[300px] bg-neon-cyan bottom-20 left-1/3"
        style={{ opacity: 0.05 }}
      />
        ...
        <div className="grid lg:grid-cols-[1fr_auto] lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-start gap-8">
            ...
            <p className="text-subtle text-lg max-w-xl leading-relaxed">
              ...
              convertissent. Du code propre à la croissance digitale tout sous
              un même toit.
            </p>
            ...
            <div className="flex flex-wrap gap-8 py-4 border-y border-border w-full">
              {[
                ...
                {
                  // On passe le JSX de l'image directement à la place du texte
                  value: (
                    <img
                      src={clients} 
      ...
      <button
        onClick={scrollDown}
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-muted hover:text-brand-400 transition-colors animate-bounce"
      >
